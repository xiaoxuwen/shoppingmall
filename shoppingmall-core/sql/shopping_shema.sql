...
CREATE TABLE `t_shop` (
  ...
  `business` varchar(50) DEFAULT NULL COMMENT '营业时间',
  ...
  `password` varchar(255) default 'tnkj' COMMENT '密码',
  `real_name` varchar(20) NOT NULL COMMENT '真实姓名',
...
CREATE TABLE `t_ad` (
  ...
  `position` tinyint(3) DEFAULT '1' COMMENT '广告位置：1则是首页 2.零元砍价 3.在线拼团',
...
CREATE TABLE `t_bargain_user` (
  ...
  `af` varchar(50) NOT NULL DEFAULT COMMENT '关联标记：关联发起者和参与者',
