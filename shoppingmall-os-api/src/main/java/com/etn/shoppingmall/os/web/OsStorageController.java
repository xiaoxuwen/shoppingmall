package com.etn.shoppingmall.os.web;
...
import com.etn.shoppingmall.os.service.ObjectStorageService;
...
public class OsStorageController {
    ...
    public Object delete(@RequestBody Storage storage) {
        storageService.deleteByKey(storage.getKey());
        localOsService.delete(storage.getKey());
